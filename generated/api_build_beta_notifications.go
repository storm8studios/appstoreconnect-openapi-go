...
type BuildBetaNotificationsApiBuildBetaNotificationsCreateInstanceRequest struct {
	ctx context.Context
...
func (r BuildBetaNotificationsApiBuildBetaNotificationsCreateInstanceRequest) BuildBetaNotificationCreateRequest(buildBetaNotificationCreateRequest BuildBetaNotificationCreateRequest) BuildBetaNotificationsApiBuildBetaNotificationsCreateInstanceRequest {
	r.buildBetaNotificationCreateRequest = &buildBetaNotificationCreateRequest
	return r
}

func (r BuildBetaNotificationsApiBuildBetaNotificationsCreateInstanceRequest) Execute() (*BuildBetaNotificationResponse, *http.Response, error) {
...
BuildBetaNotificationsCreateInstance Method for BuildBetaNotificationsCreateInstance
 ...
 @return BuildBetaNotificationsApiBuildBetaNotificationsCreateInstanceRequest
*/
func (a *BuildBetaNotificationsApiService) BuildBetaNotificationsCreateInstance(ctx context.Context) BuildBetaNotificationsApiBuildBetaNotificationsCreateInstanceRequest {
	return BuildBetaNotificationsApiBuildBetaNotificationsCreateInstanceRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *BuildBetaNotificationsApiService) BuildBetaNotificationsCreateInstanceExecute(r BuildBetaNotificationsApiBuildBetaNotificationsCreateInstanceRequest) (*BuildBetaNotificationResponse, *http.Response, error) {
	var (
